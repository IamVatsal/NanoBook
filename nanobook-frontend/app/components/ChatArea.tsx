      ...
      <div className="h-16 flex items-center justify-between px-4 md:px-8 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 z-10 sticky top-0">
        <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm font-semibold text-slate-700 dark:text-slate-200 truncate max-w-[120px] md:max-w-none">Research Session</span>
          </div>
        </div>
      </div>
      ...
      >
        {messages.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center max-w-2xl mx-auto text-center px-4">
            <h2 className="text-2xl md:text-3xl font-serif text-slate-800 dark:text-white mb-4">Good Afternoon, Researcher.</h2>
            <p className="text-slate-500 dark:text-slate-400 text-base md:text-lg leading-relaxed mb-8">
              NanoBook synthesizes your sources into clear, actionable insights.
            </p>
              ...
              >
                <div className={`
                  ...
                  ${msg.role === Role.USER 
                    ...
                    : 'bg-white dark:bg-slate-900 text-slate-800 dark:text-slate-100 border border-slate-200 dark:border-slate-800 rounded-tl-none serif-text text-base md:text-[17px] leading-relaxed'}
                `}>
